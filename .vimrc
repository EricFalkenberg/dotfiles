...
" nmap <Tab> <Plug>(JavaComplete-Imports-AddSmart)
" imap <Tab> <Plug>(JavaComplete-Imports-AddSmart)

" nmap <Tab> <Plug>(JavaComplete-Imports-Add)
" imap <Tab> <Plug>(JavaComplete-Imports-Add)

" nmap <C-8> <Plug>(JavaComplete-Imports-AddMissing)
" imap <C-8> <Plug>(JavaComplete-Imports-AddMissing)

" nmap <C-8> <Plug>(JavaComplete-Imports-RemoveUnused)
" nmap <C-8> <Plug>(JavaComplete-Imports-RemoveUnused)
...
inoremap <expr><leader><Tab> neocomplete#start_manual_complete('omni')
